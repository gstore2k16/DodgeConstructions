...
| 🛠️ [Developer Experience (DX) & Governance](docs/dx-governance.md) | Prettier configuration, Husky pre-commit hooks, `lint-staged` rules, branch naming standards, and commit message conventions.                      |
