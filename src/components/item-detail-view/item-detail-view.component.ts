...
/**
 * Renders the full product detail view: image zoom, breadcrumb, price,
 * quantity picker and the Add to Cart action, or an error state when the
 * item couldn't be found/loaded.
 */
@Component({
